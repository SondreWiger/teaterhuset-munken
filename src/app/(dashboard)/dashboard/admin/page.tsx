    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 stagger">
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted leading-relaxed">
            Statistikk over brukere, kjøp og inntekt
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted leading-relaxed">
            Generer gavekort med kreditt eller rabatt
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted leading-relaxed">
            Send e-post til nyhetsbrev-abonnenter
          </p>
        </Link>
        ...
        <Link
          ...
          className="glass-card rounded-2xl p-6 group"
        >
          <div className="w-12 h-12 rounded-xl bg-danger/[0.08] flex items-center justify-center mb-4 group-hover:bg-danger/[0.12] transition-colors">
          ...
          <p className="mt-1.5 text-sm text-muted leading-relaxed">
            Håndter rapporterte kommentarer
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted leading-relaxed">
            Se hvem som gjorde hva på plattformen
          </p>
        </Link>
      </div>
    </div>
